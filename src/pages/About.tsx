...
import { Quote, Award, Rocket, Calendar, TrendingUp, Target, Users, Lightbulb, Code, Briefcase, Linkedin, Twitter, Mail } from "lucide-react";
          ...
          <div className="grid md:grid-cols-[280px,1fr] gap-8 items-start">
            <div className="rounded-xl border border-border bg-card shadow-md p-4">
              <img 
                ...
                alt="Divyesh Bondapalli - Founder & Managing Director" 
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="relative mb-6">
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-purple-500 to-silver-500 p-1">
                      <div className="w-full h-full rounded-full bg-background flex items-center justify-center">
                        <img 
                          src="/neelambika-coo.jpg" 
                          alt="P. Neelambika - COO" 
                          className="w-full h-full rounded-full object-cover"
                          onError={(e) => {
                            // Fallback to initials if image not found
                            e.currentTarget.style.display = 'none';
